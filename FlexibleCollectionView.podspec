#
# Be sure to run `pod lib lint FlexibleCollectionView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FlexibleCollectionView.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/FlexibleCollectionView.git', :tag => s.version.to_s }
